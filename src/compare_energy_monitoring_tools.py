...
df.boxplot(column=["energy_consumption_llm_cpu_scaphandre", "energy_consumption_llm_cpu_pyjoules", "cpu_energy_codecarbon", "energy_consumption_llm_cpu_energymeter"], ax=axs[0])
...
df.boxplot(column=["energy_consumption_llm_gpu_scaphandre", "energy_consumption_llm_gpu_pyjoules", "gpu_energy_codecarbon", "energy_consumption_llm_gpu_energymeter"], ax=axs[1])
...
df.boxplot(column=["energy_consumption_llm_total_scaphandre", "energy_consumption_llm_total_pyjoules", "energy_consumed_codecarbon", "energy_consumption_llm_total_energymeter"], ax=axs[2])
